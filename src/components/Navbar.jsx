...
export default function Navbar({ search, setSearch }) {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 flex justify-center z-50">
      <nav className="w-[92%] max-w-5xl bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-8 py-4 flex items-center justify-between shadow-2xl">
  ...
  <div className="flex-1 px-8 hidden md:block">
    <input
      ...
      className="w-full px-5 py-2 rounded-full bg-white/20 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400"
    />
  </div>
